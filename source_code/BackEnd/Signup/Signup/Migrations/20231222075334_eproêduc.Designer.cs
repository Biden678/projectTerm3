...
namespace Signup.Migrations
{
    ...
    [Migration("20231222075334_eproêduc")]
    partial class eproêduc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Signup.Models.ClaimList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClaimLists");
                });

            modelBuilder.Entity("Signup.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Signup.Models.ForbiddenWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Signup.Models.ForgetPass", b =>
                {
                    b.Property<int>("For_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("For_Id"), 1L, 1);
            ...
            modelBuilder.Entity("Signup.Models.VehicleError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ErrorOfVehicle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("VehicleErrors");
                });

            modelBuilder.Entity("Signup.Models.ForgetPass", b =>
                {
                    b.HasOne("Signup.Models.Users", "User")
                        .WithMany()
